...
const seedDb= async()=>{
    ...
    for(let i=0;i<20;i++){
        ...
        let book= new Product({
            ...
            images:[    
              {
                url: 'https://res.cloudinary.com/artiyadav/image/upload/v1633599341/book_store/uwvvisypuvsazw2ut319.jpg',
                filename: 'book_store/uwvvisypuvsazw2ut319'
              },
              {
                url: 'https://res.cloudinary.com/artiyadav/image/upload/v1633599341/book_store/pcqa20ofswiqbznmrxwb.jpg',
